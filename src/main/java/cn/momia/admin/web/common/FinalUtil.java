...
public class FinalUtil {
    public static final int DEL_STATUS = 0;//删除标识常量定义
    public static final int ADD_STATUS = 1;

    public static final int ADD_INFO = 0;

    //登录相关常量信息
    public static final String LOGIN_BEFORE = "欢迎登录，请输入用户名和密码登录.";
    public static final String LOGIN_AFTER = "登录失败，请输入用户名和密码重新登录.";
    public static final String LOGIN_SUCCESS = "欢迎登陆多啦亲子互动平台－管理端.";
    ...
    public static final String QUERY_PAGE = "queryPage";
    ...
    public static final int PRODUCT_MARK_0 = 0;
    public static final int PRODUCT_MARK_1 = 1;
    public static final int PRODUCT_MARK_2 = 2;
    public static final int PRODUCT_MARK_3 = 3;
    public static final int PRODUCT_MARK_4 = 4;
    public static final int PRODUCT_MARK_5 = 5;
