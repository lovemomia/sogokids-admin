            ...
            <div class="box span12">
                <div class="row-fluid sortable">
                    <div class="box-header well" data-original-title>
                        <h2><i class="icon-user"></i> 地址图片</h2>
                        <div class="box-icon">
                            <a href="${ctx}/place/info.do?uid=${user.id}&pageNo=${pageNo}" class="btn btn-back btn-round"><i class="icon-remove"></i></a>
                        </div>
                    </div>
                    <div class="box-content">
                        <form class="form-horizontal" id="vform" action="${ctx}/place/addimg.do?uid=${user.id}&pid=${model.id}&pageNo=${pageNo}" enctype="multipart/form-data" method="post">
                            <fieldset>
                                <div class="control-group">
                                    <label class="control-label">地址图片</label>
                                    <div class="controls">
                                        <input class="input-xlarge focused" id="fileurl" name="fileurl" type="file" value="">
                                    </div>
                                </div>
                        ...
                        <form >
                            <table class="table table-striped table-bordered bootstrap-datatable datatable">
                                <c:forEach items="${entitys}" var="entity">
                                    <tr>
                                        <td>
                                            图片<c:out value="${entity.id}"></c:out>:
                                    ...
                                    <tr>
                                        <td class="center">
                                            <a class="btn btn-danger" href="${ctx}/place/delimg.do?uid=${user.id}&id=${entity.id}&pid=${model.id}&pageNo=${pageNo}">
