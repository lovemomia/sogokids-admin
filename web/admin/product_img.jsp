            ...
            <div class="box span12">
                <div class="row-fluid sortable">
                    <div class="box-header well" data-original-title>
                        <h2><i class="icon-user"></i> 活动图片</h2>
                        <div class="box-icon">
                            <a href="${ctx}/product/info.do?uid=${user.id}&pageNo=${pageNo}" class="btn btn-back btn-round"><i class="icon-remove"></i></a>
                        </div>
                    </div>
                    <div class="box-content">
                        <form class="form-horizontal" id="vform" action="${ctx}/product/addimg.do?uid=${user.id}&pid=${model.id}&pageNo=${pageNo}" enctype="multipart/form-data" method="post">
                            <fieldset>
                        ...
                        <form >
                            <table class="table table-striped table-bordered bootstrap-datatable datatable">
                                <c:forEach items="${entitys}" var="entity">
                                    ...
                                    <tr>
                                        <td class="center">
                                            <a class="btn btn-danger" href="${ctx}/product/delimg.do?uid=${user.id}&id=${entity.id}&pid=${model.id}&pageNo=${pageNo}">
