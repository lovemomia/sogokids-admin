            ...
            <div class="box span12">
                <div class="row-fluid sortable">
                    <div class="box-header well" data-original-title>
                        <h2><i class="icon-user"></i> 用户修改</h2>
                        <div class="box-icon">
                            <a href="${ctx}/user/info.do?uid=${user.id}&pageNo=${pageNo}" class="btn btn-back btn-round"><i class="icon-remove"></i></a>
                        </div>
                    </div>
                    <div class="box-content">
                        <form class="form-horizontal" id="userform" action="${ctx}/user/edit.do?uid=${user.id}&id=${model.id}&pageNo=${pageNo}" method="post">
                            <fieldset>
                                <input id="pageNo" name="pageNo" type="hidden" value="pageNo">
                                <div class="control-group">
                                    <label class="control-label">用户名称</label>
                                    <div class="controls">
                                        <input class="required" id="username" name="username" type="text" value="${model.username}">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label">用户密码</label>
                                    <div class="controls">
                                        <input class="required" id="password" name="password" type="text" value="${model.password}">
                                    </div>
                                </div>
