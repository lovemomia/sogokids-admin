            ...
            <div class="box span12">
                <div class="row-fluid sortable">
                    <div class="box-header well" data-original-title>
                        <h2><i class="icon-user"></i> SKU修改</h2>
                        <div class="box-icon">
                            <a href="${ctx}/sku/info.do?uid=${user.id}&pageNo=${pageNo}" class="btn btn-back btn-round"><i class="icon-remove"></i></a>
                        </div>
                    </div>
                    <div class="box-content">
                        <form class="form-horizontal" id="vform" action="${ctx}/sku/edit.do?uid=${user.id}&id=${model.id}&pageNo=${pageNo}" method="post">
                            <fieldset>
                                    ...
                                    <div class="controls">
                                        <select id="productId" name="productId">
                                            <c:forEach items="${entitys}" var="node">
                                                <c:choose>
                                                    <c:when test="${node.id == model.productId}">
