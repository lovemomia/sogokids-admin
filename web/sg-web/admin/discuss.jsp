...
<div id="wrapper">
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            ...
            <div class="col-lg-2">
                <h2><a href="${ctx}/discuss/oper.do?uid=${user.id}&id=0" class="btn btn-primary btn-x">创建话题</a></h2>
            </div>
        </div>
        <div class="row">
                        ...
                        <c:forEach items="${entitys}" var="entity">
                            <tr>
                                ...
                                <td class="center">
                                    <c:choose>
                                        <c:when test="${entity.status == 1}">
                                            <a href="${ctx}/discuss/upOrDown.do?uid=${user.id}&id=${entity.id}&mark=4" class="btn btn-danger btn-sm"><i class="fa fa-level-down"></i> 下线 </a>
                                        </c:when>
                                        <c:otherwise>
                                            <a href="${ctx}/discuss/upOrDown.do?uid=${user.id}&id=${entity.id}&mark=1" class="btn btn-primary btn-sm"><i class="fa fa-level-up"></i> 上线 </a>
                                        </c:otherwise>
                                    </c:choose>
