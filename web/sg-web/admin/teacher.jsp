...
<head>
    ...
    <style>
        #linknav{height: 1000px;border-radius: 5px;}
        #linknav ul{float:left;list-style-type:none;border-radius: 5px;}
        #linknav ul li{float:left;list-style-type:none;margin:30px;line-height:30px;margin-left:30px;margin-bottom:30px;width: 220px;border-radius: 5px;}
    ...
    <script src="${ctx}/sg-web/js/jquery-ui-1.10.4.min.js"></script>
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="row">
                ...
                <h2>
                    <form id="btn_query_teacher" action="" method="post">
                        <div class="col-lg-2">
                            <input id="name" name="name" type="text" class="form-control" value="${name}">
                        </div>
                        <div class="col-lg-1">
                            <a href="javascript:void(0)" onclick="queryTeacher()" class="btn btn-primary btn-x">搜索</a>
                        </div>
                    </form>
                </h2>
            </div>
                    ...
                    <%--<table class="table table-striped table-bordered table-hover dataTables-example">--%>
                        ...
                        <%--<c:forEach items="${entitys}" var="entity">--%>
                            <%--<tr>--%>
                                ...
                                <%--<td>--%>
                                    <%--<c:choose>--%>
                                        <%--<c:when test="${fn:contains(entity.img,'http')}">--%>
                                            <%--<img id="img_a" src="${entity.img}" style="width: 50px;height: 50px"/>--%>
                                        <%--</c:when>--%>
                                        <%--<c:otherwise>--%>
                                            <%--<img id="img_a" src="${filepath}${entity.img}" style="width: 50px;height: 50px"/>--%>
                                        <%--</c:otherwise>--%>
                                    <%--</c:choose>--%>

                                <%--</td>--%>
                                <%--<td><c:out value="${entity.action}"></c:out></td>--%>
                                <%--<td><c:out value="${entity.weight}"></c:out></td>--%>
                                <%--<td><c:out value="${fn:substring(entity.addTime,0,19)}"></c:out></td>--%>
                                <%--<td class="center">--%>
                                    <%--<a href="${ctx}/icon/oper.do?uid=${user.id}&id=${entity.id}" class="btn btn-white btn-sm"><i class="fa fa-pencil"></i> 编辑 </a>--%>
                                    <%--<a href="${ctx}/icon/del.do?uid=${user.id}&id=${entity.id}" class="btn btn-white btn-sm"><i class="fa fa-times-circle"></i> 删除 </a>--%>
                                <%--</td>--%>
                            <%--</tr>--%>
                        <%--</c:forEach>--%>
                        <%--</tbody>--%>
