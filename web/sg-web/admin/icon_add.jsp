        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>
                        <strong>创建icon信息</strong>
                    </li>
                </ol>
            </div>
            <div class="col-lg-2">
                <h2><a href="${ctx}/icon/info.do?uid=${user.id}" class="btn btn-primary btn-x">返回</a></h2>
            </div>
        </div>
        <div class="row">
            <div class="ibox-content">
                <form class="form-horizontal" id="vform" action="${ctx}/icon/add.do?uid=${user.id}" method="post">
                    <fieldset>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                            <div class="row">
                                <label class="col-sm-2 control-label">icon标题 </label>
                                <div class="col-sm-3">
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-sm-2">
                                    <img id="img_a" src="${ctx}/sg-web/img/770jiahao.jpg" style="width: 100px;height: 100px;border: 1px solid #999;" />
