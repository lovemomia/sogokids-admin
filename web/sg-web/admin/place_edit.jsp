    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="row">
            <div class="ibox-content">
                <form class="form-horizontal" id="vform" action="${ctx}/place/edit.do?uid=${user.id}&id=${model.id}" method="post">
                    <fieldset>
                        <fieldset>
                            <div class="selectList">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <select id="cityId" name="cityId" class="province form-control m-b">
                                            <option>请选择</option>
                                        </select>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input id="lng_lat" name="lng_lat" type="text" class="form-control" value="${model.lng},${model.lat}" >
                                    </div>
                                    <div class="col-sm-3">
...
<script language="JavaScript">
    $(function() {
        $(".selectList").each(function(){
            ...
            var url = "/place/datajson.do?id="+$("#id").val();
            var areaJson;
            var temp_html;
            ...
            var province = function(){
                $.each(areaJson,function(i,province){
                    if(province.selected == 1){
                        temp_html+="<option value='"+province.id+"' selected>"+province.name+"</option>";
                    }else{
            ...
            var city = function(){
                ...
                if(regions == undefined){
                    ...
                    $.each(areaJson[n].regions,function(i,city){
                        if(city.selected == 1) {
                            temp_html += "<option value='" + city.id + "' selected>" + city.name + "</option>";
                        }else{
                ...
                if(n == -1){
                    ...
                    $.each(areaJson[m].regions[n].regchild,function(i,district){
                        if(district.selected == 1) {
                            temp_html += "<option value='" + district.id + "' selected>" + district.name + "</option>";
                        }else{
...
//            window.location = "http://api.map.baidu.com/lbsapi/getpoint/index.html";
        });
