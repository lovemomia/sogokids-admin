    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="row">
            <div class="ibox-content">
                <form class="form-horizontal" id="vform" action="${ctx}/discuss/add.do?uid=${user.id}" method="post">
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-2" style="cursor: pointer;">
                                <img id="img_a" src="${ctx}/sg-web/img/770jiahao.jpg" style="width: 200px;height: 160px;border: 1px solid #999;"/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <input id="title" name="title" type="text" class="form-control" maxlength="14" placeholder="最多可输入14个字...">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <input id="subTitle" name="subTitle" type="text" maxlength="12" class="form-control" placeholder="最多可输入12个字...">
                                </div>
                            </div>
                        <%--<div class="form-group">--%>
