                        ...
                        <c:forEach items="${entitys}" var="entity">
                            <tr>
                                ...
                                <td class="center">
                                    <c:choose>
                                        <c:when test="${entity.status == 1}">
                                            <a href="${ctx}/book/upOrDown.do?uid=${user.id}&id=${entity.id}&mark=3" class="btn btn-white btn-sm"><i class="fa fa-level-down"></i> 下线 </a>
                                        </c:when>
                                        <c:otherwise>
                                            <a href="${ctx}/book/oper.do?uid=${user.id}&id=${entity.id}&mark=8" class="btn btn-white btn-sm"><i class="fa fa-pencil"></i> 编辑 </a>
                                            ...
                                            <a href="${ctx}/book/upOrDown.do?uid=${user.id}&id=${entity.id}&mark=1" class="btn btn-white btn-sm"><i class="fa fa-level-up"></i> 上线 </a>
                                        </c:otherwise>
                                    </c:choose>
                                </td>
                            </tr>
...
<script>
    ...
    function delCourse(id){
        layer.confirm('您确定要删除此试听课吗？', function(index){
            window.location.href="${ctx}/book/del.do?uid=${user.id}&id="+id;
            layer.close(index);
        });
