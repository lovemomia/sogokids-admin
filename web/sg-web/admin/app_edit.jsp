        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a href="${ctx}/app/info.do?uid=${user.id}">App版本</a>
                    </li>
                    <li>
                        <strong>编辑App版本信息</strong>
                    </li>
                </ol>
            </div>
            <div class="col-lg-2">
                <h2><a href="${ctx}/app/info.do?uid=${user.id}" class="btn btn-primary btn-x">返回</a></h2>
            </div>
        </div>
        <div class="row">
            <div class="ibox-content">
                <form class="form-horizontal" id="vform" action="${ctx}/app/edit.do?uid=${user.id}&id=${model.id}" method="post">
                    <fieldset>
                        <%--<div class="hr-line-dashed"></div>--%>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">版本号 </label>
                            <div class="col-sm-8">
                                <input id="code" name="code" type="text" class="form-control" value="${model.versionCode}">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <textarea id="desc" name="desc" class="form-control"rows="5" style="resize:none;">${model.versionDesc}</textarea>
                            </div>
                        </div>
