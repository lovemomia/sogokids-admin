        ...
        <div class="row">
            <div class="ibox-content">
                <form class="form-horizontal" id="vform" action="${ctx}/teacher/editMaterial.do?uid=${user.id}" method="post">
                    <fieldset>
                        <input id="id" name="id" type="hidden" value="${courseMaterial.id}">
                        <div class="selectList">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <script id="my_editor" name = "content" type="text/plain">${courseMaterial.content}</script>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-sm-4 col-sm-offset-5">
                                    <button class="btn btn-primary" type="submit" style="width: 30%;">保存</button>
                                </div>
                            </div>
                        </div>
                    </fieldset>
...
<script language="JavaScript">
    $(document).ready(function () {
        ...
        $(".selectList").each(function(){
            var url = "/teacher/dataJson.do?id="+$("#id").val();
            var areaJson;
            var temp_html;
                ...
                if(courses == undefined){
                    ...
                    $.each(areaJson[n].courses,function(i,course){
                        if(course.selected == 1){
                            temp_html+="<option value='"+course.id+"' selected>"+course.title+"</option>";
                        }else{
