...
<div id="wrapper">
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            ...
            <div class="col-lg-2">
                <h2><a href="${ctx}/inst/info.do?uid=${user.id}" class="btn btn-primary btn-x">返回</a></h2>
            </div>
        </div>
        <div class="row">
            <div class="ibox-content">
                <form class="form-horizontal" id="vform" action="${ctx}/inst/edit.do?uid=${user.id}&id=${model.id}" method="post">
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <img id="img_a" src="${filepath}${model.cover}" style="width: 265px;height: 135px;border: 1px solid #999;"/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <textarea id="intro" name="intro" rows="10" class="form-control" rows="8" style="resize:none;">${model.intro}</textarea>
                            </div>
                        </div>
