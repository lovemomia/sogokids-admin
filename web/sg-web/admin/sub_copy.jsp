    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav" id="side-menu">
                ...
                <li class="active"><a href="${ctx}/book/info.do?uid=${user.id}"><i class="fa fa-leanpub"></i> <span class="nav-label">试听课程</span> </a></li>
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a href="${ctx}/book/info.do?uid=${user.id}">课程信息</a>
                    </li>
                    <li>
                        <strong>编辑试听课</strong>
                    </li>
                ...
                <form class="form-horizontal" id="copy_form" action="" method="post">
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <input id="price" name="price" type="text" class="form-control" value="${subSku.price}" >
                                <input id="course_id" name="course_id" type="hidden" value="${model.id}">
                            </div>
                            <%--<label class="col-sm-2 control-label">原始价格 </label>--%>
                            <%--<div class="col-sm-3">--%>
                                <%--<input id="originalPrice" name="originalPrice" type="text" class="form-control" value="${subSku.originalPrice}" >--%>
                            <%--</div>--%>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <textarea id="notice" name="notice" class="form-control" rows="5" style="resize:none;">${course_c.notice}</textarea>
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                            <div class="col-sm-4 col-sm-offset-5">
                                <button id="btn_copy_save" name="btn_copy_save" class="btn btn-primary" type="button">保存内容</button>
                            </div>
                        </div>
                    </fieldset>
                </form>
...
//                    alert($(this).val());
//                });
                $.post("/book/copy.do?uid=${user.id}", $("#copy_form").serialize(),
                        function(data){
                            if(data.success == 0){
//                                layer.alert(data.msg,10,'提示信息');
        ...
        $(":checkbox").change(function() {
            ...
            if ($(this).is(':checked')) {
                $("#stock_"+checkbox_id).val($("#y_stock_"+checkbox_id).val());
                $("#stock_"+checkbox_id).removeAttr("readonly");
            }else{
                $("#stock_"+checkbox_id).val($("#un_stock_"+checkbox_id).val());
                $("#stock_"+checkbox_id).attr({ readonly: 'true' });
//                $("#stock_"+checkbox_id).css("background", "#999");
            }
        });
