...
<head>
    ...
    <style>
        #linknav{height: 1000px;}
        #linknav ul{float:left;list-style-type:none;}
        #linknav ul li{float:left;list-style-type:none;margin:20px;line-height:40px;margin-left:45px;margin-bottom:50px;height: 162px;width: 202px;}
        /*#linknav ul li a img{ border:1px solid #aaa; display:block; width:200px; height:160px; text-decoration:none; margin:0 0 -1px -1px; position:relative; z-index:0; text-align:center; color:#fff;}*/
        /*#linknav ul li a img:hover{ border:2px solid #333; z-index:1;}*/
        ...
        .images-content{
            ...
            /*-webkit-gradient(linear,0 0,0 100%,from(#E0E0E0),to(#5B5B5B));*/
            height: 160px;
            line-height: 160px;
            overflow: hidden;
        }
                ...
                <div id="linknav">
                    ...
                    <ul>
                        <c:forEach items="${entitys}" var="entity">
                                <li class="images-wrapper">
                                    <a href="${ctx}/course/info.do?uid=${user.id}&subid=${entity.id}">
                                        <img src="${filepath}${entity.cover}" class="img"/>
                                        <div class="images-content">${entity.title}</div>
                                    </a>
                                    <div align="center">
                                        <c:choose>
                                            ...
                                            <c:otherwise>
                                                <a href="${ctx}/sub/oper.do?uid=${user.id}&id=${entity.id}" class="btn btn-primary btn-sm"><i class="fa fa-pencil"></i> 编辑 </a>&numsp;
                                                <%--<a href="${ctx}/sub/del.do?uid=${user.id}&id=${entity.id}" class="btn btn-danger btn-sm"><i class="fa fa-times-circle"></i> 删除 </a>&numsp;--%>
                                                <a href="javascript:void(0)" onclick="delSubject(${entity.id})" class="btn btn-danger btn-sm"><i class="fa fa-times-circle"></i> 删除 </a>&numsp;
                                                <a href="${ctx}/sub/upOrDown.do?uid=${user.id}&id=${entity.id}&mark=1" class="btn btn-warning btn-sm"><i class="fa fa-level-up"></i> 上线 </a>
                                            </c:otherwise>
                                        </c:choose>
                                    </div>
                                </li>
                        ...
                        <li class="images-wrapper">
                            <a href="${ctx}/sub/oper.do?uid=${user.id}&id=0">
                                <img src="${ctx}/sg-web/img/770jiahao.jpg" class="img"/>
