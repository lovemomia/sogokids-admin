        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a href="${ctx}/coop_user/info.do?uid=${user.id}">人员信息</a>
                    </li>
                    <li>
                        <strong>创建人员</strong>
                    </li>
            ...
            <div class="col-lg-2">
                <h2><a href="${ctx}/coop_user/info.do?uid=${user.id}" class="btn btn-primary btn-x">返回</a></h2>
            </div>
        </div>
        <div class="row">
            <div class="ibox-content">
                <form class="form-horizontal" id="busUserform" action="${ctx}/coop_user/add.do?uid=${user.id}" method="post">
                    <fieldset>
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label">人员密码 </label>
                            <div class="col-sm-3">
                        ...
                        <div class="form-group">
                            <div class="col-sm-4 col-sm-offset-5">
                                <button class="btn btn-primary" type="button" id="btn_save_user" name="btn_save_user">保存内容</button>
                            </div>
                        </div>
                    </fieldset>
                </form>
...
<script language="JavaScript">
    $(document).ready(function () {
        $('#btn_save_user').click(function (){
            ...
            if(name == null || name == ""){
                layer.alert('请填写人员名称信息！',3,'提示信息');
                return false;
            }else if(password == null || password == ""){
                layer.alert('请填写人员密码信息！',3,'提示信息');
                return false;
            }else {
                $.post("/coop_user/verify.do", {name:name},
                        function (data) {
                            if (data.success == 0) {
                                $('#busUserform').submit();
                            }else{
