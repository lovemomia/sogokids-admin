    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="row">
            <div class="ibox-content">
                <form class="form-horizontal" id="vform" action="${ctx}/expert/add.do?uid=${user.id}" method="post">
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <textarea id="intro" name="intro" class="form-control" rows="5" style="resize:none;"></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <textarea id="address" name="address" class="form-control" rows="5" style="resize:none;"></textarea>
                            </div>
                        </div>
                        <div class="form-group">
        ...
        $('#btn_save').click(function(){
            ...
            if(mobile == null || mobile == ""){
                ...
                $.post("/expert/isMobile.do", {mobile : mobile},
                        function(data){
                            if(data.success == 0){
                                $.post("/expert/add.do?uid=${user.id}&userId="+data.userId, $("#vform").serialize(),
                                        function(data){
                                            //console.log(data);
                                            if(data.success == 0){
                                                window.location.href="${ctx}/expert/info.do?uid=${user.id}";
                                            }else{
