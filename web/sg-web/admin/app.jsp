                ...
                <form>
                    <table class="table table-striped table-bordered table-hover dataTables-example">
                        ...
                        <c:forEach items="${entitys}" var="entity">
                            <tr>
                                <td><c:out value="${entity.versionCode}"></c:out></td>
                                <td><c:out value="${entity.versionDesc}"></c:out></td>
                                <td><c:out value="${fn:substring(entity.addTime,0,19)}"></c:out></td>
                                <td class="center">
                                    <a href="${ctx}/app/oper.do?uid=${user.id}&id=${entity.id}&mark=2" class="btn btn-white btn-sm"><i class="fa fa-pencil"></i> 编辑 </a>
                                    <a href="${ctx}/app/del.do?uid=${user.id}&id=${entity.id}" class="btn btn-white btn-sm"><i class="fa fa-times-circle"></i> 删除 </a>
                                </td>
                            </tr>
                        </c:forEach>
                        </tbody>
