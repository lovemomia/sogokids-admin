    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="row">
            <div class="ibox-content">
                <form class="form-horizontal" id="vform" action="${ctx}/coop/add.do?uid=${user.id}" method="post">
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-2" style="cursor: pointer;">
                                    <img id="img_a" src="${ctx}/sg-web/img/770jiahao.jpg" style="width: 200px;height: 180px;border: 1px solid #999;"/>
