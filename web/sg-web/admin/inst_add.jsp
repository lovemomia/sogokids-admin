    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="row">
            <div class="ibox-content">
                <form class="form-horizontal" id="vform" action="${ctx}/inst/add.do?uid=${user.id}" method="post">
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3" style="cursor: pointer;">
                                <img id="img_a" src="${ctx}/sg-web/img/770jiahao.jpg" style="width: 265px;height: 135px;border: 1px solid #999;"/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <textarea id="intro" name="intro" class="form-control" rows="8" style="resize:none;"></textarea>
                            </div>
                        </div>
