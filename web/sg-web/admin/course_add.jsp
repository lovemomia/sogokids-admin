                                        ...
                                        <form class="form-horizontal" id="course_form" action="" method="post">
                                            <fieldset>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <input id="feature" name="feature" type="text" maxlength="6" class="form-control" placeholder="最多输入6个字...">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <%--<div class="col-sm-7">--%>
                                                <%--<select id="subjectId" name="subjectId" class="form-control m-b" >--%>
                                                ...
                                                <%--<div class="form-group">--%>
                                                    ...
                                                    <%--<div class="col-sm-8">--%>
                                                        <%--<textarea id="recommend" name="recommend" class="form-control" rows="5" placeholder="" style="resize:none;"></textarea>--%>
                                                    <%--</div>--%>
                                                <%--</div>--%>
                                                <div class="form-group">
                                            ...
                                            <fieldset>
                                                <div class="row">
                                                    <div class="ibox-content">
                                                        ...
                                                        <div class="form-group">
                                                            <div class="col-sm-12">
                                                                <textarea id="abstracts" name="abstracts" class="form-control" rows="3" style="resize: none;"></textarea>
