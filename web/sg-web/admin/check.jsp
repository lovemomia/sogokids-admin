...
<div id="wrapper">
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            ...
            <%--<div class="col-lg-2">--%>
                <%--<h2><a href="${ctx}/app/oper.do?uid=${user.id}&id=0&mark=0" class="btn btn-primary btn-x">创建App版本信息</a></h2>--%>
            <%--</div>--%>
        </div>
        <div class="row">
                ...
                <div class="panel-heading">
                    ...
                    <div class="panel-options">
                        <ul class="nav nav-tabs">
                            <li class="active"><a data-toggle="tab" href="tabs_panels.html#tab-1">待审核</a></li>
                            <li class=""><a data-toggle="tab" href="tabs_panels.html#tab-2">未通过</a></li>
                        </ul>
                    </div>
                </div>
                        ...
                        <div id="tab-1" class="tab-pane active">
                            <form>
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                    <c:forEach items="${d_check}" var="entity">
                                        <tr>
                                            <td><c:out value="${entity.name}"></c:out></td>
                                            <td><c:out value="${entity.gender}"></c:out></td>
                                            <td><c:out value="${entity.age}"></c:out>岁</td>
                                            <td><c:out value="${entity.teacherEducation.school}"></c:out></td>
                                            <td><c:out value="${entity.teacherEducation.level}"></c:out></td>
                                            <td>
                                                <c:choose>
                                                    <c:when test="${entity.status == 3}">待审核</c:when>
                                                    <c:otherwise><font color="#F8AC59"> 面试中</font></c:otherwise>
                                                </c:choose>
                                            </td>
                                            <td class="center">
                                                <c:choose>
                        ...
                        <div id="tab-2" class="tab-pane">
                            <form>
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                    <c:forEach items="${y_check}" var="entity">
                                        <tr>
                                            <td><c:out value="${entity.name}"></c:out></td>
                                            <td><c:out value="${entity.gender}"></c:out></td>
                                            <td><c:out value="${entity.age}"></c:out>岁</td>
                                            ...
                                            <td>
                                                <c:choose>
                                                    <c:when test="${entity.status == 4}"><font color="#ED5565">简历未通过</font></c:when>
                                                    <c:otherwise><font color="#F8AC59"> 面试未通过</font></c:otherwise>
                                                </c:choose>
                                            </td>
                                            <td class="center">
