        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a href="${ctx}/deal/group.do?uid=${user.id}">用户拼团</a>
                    </li>
                    <li>
                        <strong>数据列表</strong>
                    </li>
                ...
                <form>
                    <table class="table table-striped table-bordered table-hover dataTables-example">
                        ...
                        <c:forEach items="${entitys}" var="entity">
                            <tr>
                                <td><c:out value="${entity.dealGroupSubject.title}"></c:out></td>
                                <td><c:out value="${entity.customer.nickName}"></c:out>(<c:out value="${entity.customer.mobile}"></c:out>)</td>
                                <td><c:out value="${entity.maxJoinCount}"></c:out></td>
                                <td>
                                    <c:out value="${fn:substring(entity.endTime,0,19)}"></c:out>
                                </td>
                                <td class="center">
                                    <a href="${ctx}/deal/join.do?uid=${user.id}&id=${entity.id}" class="btn btn-white btn-sm"><i class="fa fa-pencil"></i> 参团人员 </a>
                                </td>
                            </tr>
                        </c:forEach>
                        </tbody>
