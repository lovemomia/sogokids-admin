            ...
            <ul class="nav" id="side-menu">
                ...
                <li class="active">
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li class="active"><a href="${ctx}/event/info.do?uid=${user.id}"><i class="fa fa-globe"></i> <span class="nav-label">event设置</span> </a></li>
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a href="${ctx}/icon/info.do?uid=${user.id}">event信息</a>
                    </li>
                    <li>
                        <strong>数据列表</strong>
                    </li>
            ...
            <div class="col-lg-2">
                <h2><a href="${ctx}/event/oper.do?uid=${user.id}&id=0" class="btn btn-primary btn-x">创建event信息</a></h2>
            </div>
        </div>
        <div class="row">
