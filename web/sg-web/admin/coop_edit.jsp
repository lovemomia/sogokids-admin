        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a href="${ctx}/coop/info.do?uid=${user.id}">单位信息</a>
                    </li>
                    <li>
                        <strong>编辑单位</strong>
                    </li>
            ...
            <div class="col-lg-2">
                <h2><a href="${ctx}/coop/info.do?uid=${user.id}" class="btn btn-primary btn-x">返回</a></h2>
            </div>
        </div>
        <div class="row">
            <div class="ibox-content">
                <form class="form-horizontal" id="vform" action="${ctx}/coop/edit.do?uid=${user.id}&id=${model.id}" method="post">
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label">机构图</label>
                                <div class="col-sm-3" style="cursor: pointer;">
                                    <c:choose>
                                        <c:when test="${fn:contains(model.cover,'http')}">
                                            <img id="img_a" src="${model.cover}" style="width: 200px;height: 180px;border: 1px solid #999;"/>
                                        </c:when>
                                        <c:otherwise>
                                            <img id="img_a" src="${filepath}${model.cover}" style="width: 200px;height: 180px;border: 1px solid #999;"/>
                                        </c:otherwise>
                                    </c:choose>
