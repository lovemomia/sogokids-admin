        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a href="${ctx}/deal/join.do?uid=${user.id}">用户信息</a>
                    </li>
                    <li>
                        <strong>数据列表</strong>
                    </li>
            ...
            <div class="col-lg-2">
                <h2><a href="${ctx}/deal/group.do?uid=${user.id}" class="btn btn-primary btn-x">返回</a></h2>
            </div>
        </div>
        <div class="row">
                    ...
                    <table class="table table-striped table-bordered table-hover dataTables-example">
                        ...
                        <c:forEach items="${entitys}" var="entity">
                            <tr>
                                ...
                                <td>
                                    <c:choose>
                                        <c:when test="${entity.refundId > 0}">
                                            <font color="#1AB394">已返现</font>
                                        </c:when>
                                        <c:otherwise>
                                            <font color="#ED5565"> 未返现</font>
                                        </c:otherwise>
                                    </c:choose>
                                </td>
                                <td class="center">
