        ...
        <div class="sidebar-collapse">
            <ul class="nav" id="side-menu">
                ...
                <li class="active">
                    ...
                    <ul class="nav nav-second-level">
                        <li class="active"><a href="${ctx}/coop/info.do?uid=${user.id}"><i class="fa fa-spinner"></i> <span class="nav-label">单位管理</span> </a></li>
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a href="${ctx}/coop/info.do?uid=${user.id}">单位管理</a>
                    </li>
                    <li>
                        <strong>数据列表</strong>
                    </li>
            ...
            <div class="col-lg-2">
                <h2><a href="${ctx}/coop/oper.do?uid=${user.id}&id=0&mark=0" class="btn btn-primary btn-x">创建单位</a></h2>
            </div>
        </div>
        <div class="row">
                    ...
                    <table class="table table-striped table-bordered table-hover dataTables-example">
                        ...
                        <c:forEach items="${entitys}" var="entity">
                            <tr>
                                    ...
                                    <div class="chat">
                                        <c:choose>
                                            <c:when test="${fn:contains(entity.cover,'http')}">
                                                <img src="${entity.cover}" class="chat-avatar" style="width: 80px;height: 80px;"/>
                                            </c:when>
                                            <c:otherwise>
                                                <img src="${filepath}${entity.cover}" class="chat-avatar" style="width: 80px;height: 80px;"/>
                                            </c:otherwise>
                                        </c:choose>
                                        <div>
                                ...
                                <td class="center">
                                    <a href="${ctx}/coop/oper.do?uid=${user.id}&id=${entity.id}&mark=1" class="btn btn-white btn-sm"><i class="fa fa-pencil"></i> 编辑 </a>
                                    <a href="${ctx}/coop/del.do?uid=${user.id}&id=${entity.id}" class="btn btn-white btn-sm"><i class="fa fa-times-circle"></i> 删除 </a>
                                </td>
                            </tr>
                        </c:forEach>
                        </tbody>
