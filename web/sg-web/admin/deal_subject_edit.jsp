    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
                ...
                <ol class="breadcrumb">
                    ...
                    <li><a href="${ctx}/deal/info.do?uid=${user.id}">拼团信息</a></li>
                    <li><strong>编辑拼团</strong></li>
                </ol>
            </div>
            <div class="col-lg-2">
        ...
        <div class="row">
            <div class="ibox-content">
                <form class="form-horizontal" id="vform" action="${ctx}/deal/edit.do?uid=${user.id}" method="post">
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-2">
                                <input id="maxJoinCount" name="maxJoinCount" type="text" class="form-control" value="${model.maxJoinCount}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">拼团天数 </label>
                            <div class="col-sm-2">
                                <input id="days" name="days" type="text" class="form-control" value="${model.days}">
                            </div>
                        </div>
...
<script language="JavaScript">
    $(document).ready(function () {
        ...
        $(".selectList").each(function(){
            var url = "/deal/dataJson.do?id="+$("#id").val();
            var areaJson;
            var temp_html;
            ...
            var subject = function(){
                $.each(areaJson,function(i,subject){
                    if(subject.selected == 1){
                        temp_html+="<option value='"+subject.id+"' selected>"+subject.title+"</option>";
                    }else{
            ...
            var sku = function(){
                ...
                if(subjectSkus == undefined){
                    ...
                    $.each(areaJson[n].subjectSkus,function(i,subjectSku){
                        if(subjectSku.selected == 1){
                            temp_html+="<option value='"+subjectSku.id+"' selected>"+subjectSku.ld_name+"</option>";
                        }else{
