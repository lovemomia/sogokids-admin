    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="row">
            <div class="ibox-content">
                <form class="form-horizontal" id="vform" action="${ctx}/expert/course_edit.do?uid=${user.id}&id=${model.id}" method="post">
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <textarea id="subhead" name="subhead" class="form-control" rows="3" style="resize:none;">${model.subHead}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <select id="expertId" name="expertId" class="form-control" >
                                    <c:forEach items="${experts}" var="node">
                                        <c:choose>
                                            <c:when test="${node.id == model.expertId}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <input id="mins" name="mins" type="text" class="form-control" value="${model.mins}">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input id="startTime" name="startTime" type="text" class="form-control layer-date" placeholder="YYYY-MM-DD hh:mm:ss" onclick="laydate({istime: true, format: 'YYYY-MM-DD hh:mm:ss'})" value="${fn:substring(model.startTime,0,19)}" readonly>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">结束时间</label>
                            <div class="col-sm-4">
                                <input id="endTime" name="endTime" type="text" class="form-control layer-date" placeholder="YYYY-MM-DD hh:mm:ss" onclick="laydate({istime: true, format: 'YYYY-MM-DD hh:mm:ss'})" value="${fn:substring(model.endTime,0,19)}" readonly>
                            </div>
                        </div>
                        <div class="form-group">
