    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="row">
            <div class="ibox-content">
                <form class="form-horizontal" id="vform" action="${ctx}/course/addDetail.do?uid=${user.id}&course_id=${course.id}" method="post">
                    <fieldset>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                            <div class="col-sm-12">
                                <textarea id="abstracts" name="abstracts" class="form-control">${model.abstracts}</textarea>
                                <input id="d_id" name="d_id" type="hidden" value="${model.id}">
                        ...
                        <div class="form-group">
                            <div class="col-sm-12">
                                <script id="my_editor" name = "detail" type="text/plain">${model.detail}</script>
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                            <div class="col-sm-4 col-sm-offset-5">
                                <button class="btn btn-primary" type="button" id="btn_courDetail_save" name="btn_courDetail_save">保存内容</button>
                            </div>
                        </div>
                    </fieldset>
                </form>
    ...
    $(document).ready(function () {
        ...
        $('#btn_courDetail_save').click(function(){
            ...
            if(abstracts == null || abstracts == ""){
                ...
                $.post("/course/addDetail.do", $("#vform").serialize(),
                        function(data){
                            if(data.success == 0){
