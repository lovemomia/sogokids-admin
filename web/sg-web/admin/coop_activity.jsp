            ...
            <ul class="nav" id="side-menu">
                ...
                <li class="active">
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li class="active"><a href="${ctx}/coop_activity/info.do?uid=${user.id}"><i class="fa fa-joomla"></i> <span class="nav-label">活动管理</span> </a></li>
                    </ul>
                </li>
                <li>
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a href="${ctx}/coop_activity/info.do?uid=${user.id}">活动管理</a>
                    </li>
                    <li>
                        <strong>数据列表</strong>
                    </li>
            ...
            <div class="col-lg-2">
                <h2><a href="${ctx}/coop_activity/oper.do?uid=${user.id}&id=0&mark=0" class="btn btn-primary btn-x">创建活动</a></h2>
            </div>
        </div>
        <div class="row">
                        ...
                        <c:forEach items="${entitys}" var="entity">
                            <tr>
                                    ...
                                    <div class="chat">
                                        <c:choose>
                                            <c:when test="${fn:contains(entity.cover,'http')}">
                                                <img src="${entity.cover}" class="chat-avatar" style="width: 100px;height: 50px;"/>
                                            </c:when>
                                            <c:otherwise>
                                ...
                                <td class="center">
                                    ...
                                    <a href="${ctx}/coop_activity/del.do?uid=${user.id}&id=${entity.id}" class="btn btn-white btn-sm"><i class="fa fa-times-circle"></i> 删除 </a>
                                </td>
                            </tr>
                        </c:forEach>
                        </tbody>
