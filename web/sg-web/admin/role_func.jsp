            ...
            <ul class="nav" id="side-menu">
                ...
                <li class="active">
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li class="active"><a href="${ctx}/role/info.do?uid=${user.id}"><i class="fa fa-graduation-cap"></i> <span class="nav-label">角色设置</span> </a></li>
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a href="${ctx}/role/info.do?uid=${user.id}">角色信息</a>
                    </li>
                    <li>
                        <strong>角色权限</strong>
                    </li>
            ...
            <div class="col-lg-2">
                <h2><a href="${ctx}/role/info.do?uid=${user.id}" class="btn btn-primary btn-x">返回</a></h2>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-12">
                        ...
                        <div class="row">
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        <div class="list-group" style="height:500px;overflow:auto;">
                                            <form id="y_form" action="${ctx}/role/roleFunc.do?uid=${user.id}&mark=1" method="post">
                                                <input type="hidden" id="y_roleId" name="y_roleId" value="${model.id}">
                                                <table class="table table-striped table-bordered table-hover dataTables-example">
                                                    ...
                                                    <tbody>
                                                    <c:forEach items="${y_list}" var="entity">
                                                        <tr>
                                                            <td>
                                                                <input id="y_func" name="y_func" type="checkbox" value="${entity.id}">
                            ...
                            <div class="col-lg-2">
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        <div class="list-group" style="height:500px;overflow:auto;">
                                            <p>&numsp;</p><p>&numsp;</p>
                                            <p align="center"><button id="add_btn_func" name="add_btn_func" type="button" class="btn btn-primary btn-sm"> <i class="fa fa-mail-reply"></i>添加 </button></p>
                                            <p>&numsp;</p><p>&numsp;</p>
                                            <p align="center"><button id="del_btn_func" name="del_btn_func" type="button" class="btn btn-danger btn-sm"> 取消<i class="fa fa-mail-forward"></i> </button></p>
                                            <p>&numsp;</p><p>&numsp;</p>
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-4">
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        <div class="list-group" style="height:500px;overflow:auto;">
                                            <form id="w_form" action="${ctx}/role/roleFunc.do?uid=${user.id}&mark=2" method="post">
                                                <input type="hidden" id="w_roleId" name="w_roleId" value="${model.id}">
                                                <table class="table table-striped table-bordered table-hover dataTables-example">
                                                    <thead>
                                                    <tr class="gradeX">
                                                        <th>权限</th>
                                                    ...
                                                    <tbody>
                                                    <c:forEach items="${w_list}" var="entity">
                                                        <tr>
                                                            <td>
                                                                <input id="w_func" name="w_func" type="checkbox" value="${entity.id}">
                                                                <c:out value="${entity.name}"></c:out>
                                                            </td>
                                                        </tr>
                                                    </c:forEach>
...
//        });
        ...
        $('#add_btn_func').click(function (){
            $('#w_form').submit();
        });

        $('#del_btn_func').click(function (){
            $('#y_form').submit();
        });
