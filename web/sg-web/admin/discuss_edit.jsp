    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav" id="side-menu">
                ...
                <li class="active"><a href="${ctx}/discuss/info.do?uid=${user.id}"><i class="fa fa-comments-o"></i> <span class="nav-label">话题管理</span></a></li>
                <li>
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a href="${ctx}/discuss/info.do?uid=${user.id}">话题信息</a>
                    </li>
                    <li>
                        <strong>编辑话题</strong>
                    </li>
            ...
            <div class="col-lg-2">
                <h2><a href="${ctx}/discuss/info.do?uid=${user.id}" class="btn btn-primary btn-x">返回</a></h2>
            </div>
        </div>
        <div class="row">
            <div class="ibox-content">
                <form class="form-horizontal" id="vform" action="${ctx}/discuss/edit.do?uid=${user.id}&id=${model.id}" method="post">
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <input id="title" name="title" type="text" class="form-control" maxlength="14" value="${model.title}" placeholder="最多可输入14个字...">
                                <input id="cityId" name="cityId" type="hidden" value="1">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <input id="subTitle" name="subTitle" type="text" maxlength="12" class="form-control" value="${model.subTitle}" placeholder="最多可输入12个字...">
                            </div>
                        </div>
                        <%--<div class="form-group">--%>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <script id="my_editor" name = "content" type="text/plain">${model.content}</script>
                            </div>
                        </div>
