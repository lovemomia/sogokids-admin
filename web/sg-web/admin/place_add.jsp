...
<head>
    ...
    <script src="${ctx}/sg-web/js/jquery-ui.custom.min.js"></script>
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="row">
            <div class="ibox-content">
                <form class="form-horizontal" id="vform" action="${ctx}/place/add.do?uid=${user.id}" method="post">
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input id="lng_lat" name="lng_lat" type="text" class="form-control" >
                            </div>
                            <div class="col-sm-3">
