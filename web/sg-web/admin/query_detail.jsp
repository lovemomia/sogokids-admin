        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a href="${ctx}/query/query.do?uid=${user.id}&startTime=${startTime}&endTime=${endTime}&title=${title}">选课查询</a>
                    </li>
                    <li>
                        <strong>订单详情</strong>
                    </li>
            ...
            <div class="col-lg-2">
                <h2><a href="${ctx}/query/query.do?uid=${user.id}&startTime=${startTime}&endTime=${endTime}&title=${title}" class="btn btn-primary btn-x">返回</a></h2>
            </div>
        </div>
        <div class="row">
