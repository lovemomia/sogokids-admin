        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a href="${ctx}/teacher/info.do?uid=${user.id}">师资力量</a>
                    </li>
                    <li>
                        <strong>已上课程</strong>
                    </li>
                ...
                <form>
                    <table class="table table-striped table-bordered table-hover dataTables-example">
                        ...
                        <tr class="gradeX">
                            ...
                            <th style="width: 30%">上课地址</th>
                        </tr>
                        </thead>
                        <tbody>
                        <c:forEach items="${teacherCourses}" var="entity">
                            <tr>
                                <td><c:out value="${entity.skuStartTime}"></c:out>-<c:out value="${entity.skuEndTime}"></c:out></td>
                                <td>
                                    <div class="chat">
