...
<div id="wrapper">
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            ...
            <div class="col-lg-2">
                <h2><a href="${ctx}/expert/course_oper.do?uid=${user.id}&id=0" class="btn btn-primary btn-x">添加微课</a></h2>
            </div>
        </div>
        <div class="row">
                    ...
                    <table class="table table-striped table-bordered table-hover dataTables-example">
                        ...
                        <c:forEach items="${entitys}" var="entity">
                            <tr>
                                <td>
                                    <div class="chat">
                                        ...
                                        <div>
                                            ...
                                            <br>
                                            <h5><c:out value="${entity.subHead}"></c:out></h5>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td class="center">
                                    <a href="${ctx}/expert/course_oper.do?uid=${user.id}&id=${entity.id}" class="btn btn-white btn-sm"><i class="fa fa-pencil"></i> 编辑 </a>
                                    <a href="${ctx}/expert/course_del.do?uid=${user.id}&id=${entity.id}" class="btn btn-white btn-sm"><i class="fa fa-times-circle"></i> 删除 </a>
                                </td>
                            </tr>
                        </c:forEach>
                        </tbody>
