            ...
            <div class="row border-bottom">
                <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
                    ...
                    <ul class="nav navbar-top-links navbar-right">
                        ...
                        <li class="dropdown">
                            <a class="dropdown-toggle count-info" data-toggle="dropdown" href="bus_index.jsp#">
                        ...
                        <table class="table table-striped table-bordered table-hover dataTables-example">
                            ...
                            <c:forEach items="${entitys}" var="entity">
                                <tr>
                                    ...
                                    <td class="center">
                                        <a href="${ctx}/bus_coop_activity/sign.do?uid=${busUser.id}&id=${entity.id}" class="btn btn-white btn-sm"><i class="fa fa-leanpub"></i> 已报名(${entity.sum_count}人) </a>
                                    </td>
                                </tr>
                            </c:forEach>
                            </tbody>
